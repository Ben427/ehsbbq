        ...
        <div className="container">
          <div className="navbar-brand">
            <Link to="/" className="navbar-item navBar-logo" title="Logo">
              <img src={logo} alt="Edmonds BBQ Logo" style={{ width: "120px", height: "auto", maxHeight: "500px"}} />
            </Link>
          ...
          >
            <div className="navbar-container">
              ...
              <a className="navbar-item" href="https://order.toasttab.com/online/hometown-smoke-and-bbq" target="_blank">
              Order now
              </a>
              </div>
