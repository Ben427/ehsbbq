        ...
        <div className="container">
          <div className="navbar-brand">
            <Link to="/" className="navbar-item navBar-logo" title="Logo">
              <img src={logo} alt="Hometown Smoke N BBQ Logo" style={{ width: "120px", height: "auto", maxHeight: "500px"}} />
            </Link>
          ...
          >
            <div className="navbar-container">
              ...
              <Link className="navbar-item" to="https://www.aukebaypizza.com/img/takeoutmenu.pdf" target="_blank">
                Menu
              </Link>
